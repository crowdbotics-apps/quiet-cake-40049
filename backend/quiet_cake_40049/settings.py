"""
Django settings for quiet_cake_40049 project.
...
ROOT_URLCONF = 'quiet_cake_40049.urls'
...
WSGI_APPLICATION = 'quiet_cake_40049.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_cake_40049 API",
    "DESCRIPTION": "API documentation for quiet_cake_40049 App",
    "VERSION": "v1",
}
